...
async def announce(model_id:UUID,body:RetirementRequest,session:Session,owner:Owner):
    with errors():
        await announce_retirement(session,actor_id=owner,model_id=model_id,announced_at=body.announced_at,shutdown_at=body.shutdown_at)
